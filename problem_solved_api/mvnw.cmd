...
:execute
@REM Configuration - Default to userproperty values
set MAVEN_OPTS=%MAVEN_OPTS%

for %%i in ("%MAVEN_PROJECTBASEDIR%\.mvn\jvm.config") do (
  if exist "%%~fi" (
    set /p MAVEN_CONFIG=<"%%~fi"
    set MAVEN_OPTS=%MAVEN_OPTS% %MAVEN_CONFIG%
  )
)
